...
import com.la.playground3.databinding.ActivityAdapterBinding;
import com.la.playground3.entity.AdapterDemoBean;
import com.la.playground3.view.apps.demo.adapter.ArrayAdapterActivity;
import com.la.playground3.view.apps.demo.adapter.BaseAdapterActivity;
import com.la.playground3.view.apps.demo.adapter.SimpleAdapterActivity;
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                switch (String.valueOf(list1.get(i).get("title"))) {
                    ...
                    case "SimpleAdapter":
                        ...
                        break;
                    case "BaseAdapter":
                        customStart(BaseAdapterActivity.class);
                        break;
                }
            }
        });
